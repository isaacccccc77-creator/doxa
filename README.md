...
- **Your room** — its own tab for how the place looks and sounds. Five palettes (Parchment, Blossom, Forest, Dark, Midnight) plus one that follows your device clock: pink at dawn, paper through the day, green in the late afternoon, warm and low in the evening, dim in the small hours. Each card is painted in the palette it offers.
