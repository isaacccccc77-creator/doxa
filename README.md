...
- **Mock papers** — sit a timed paper built from an exam's own cards. Questions are drawn across every area it covers, every answer is hidden until you finish, and then you mark yourself against the model answers. Because Doxa already projects your readiness from review history, the score is the first honest check that projection has ever had: it shows you *projected 82% → you scored 61%* and says what that gap means.
